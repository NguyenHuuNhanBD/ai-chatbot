export const BotIcon = () => {
  return (
    <svg height='16' strokeLinejoin='round' style={{ color: 'currentcolor' }} viewBox='0 0 16 16' width='16'>
      <path
        clipRule='evenodd'
...
export const StopIcon = ({ size = 16, ...props }: { size?: number } & React.SVGProps<SVGSVGElement>) => {
  return (
    <svg height={size} style={{ color: 'currentcolor', ...props.style }} viewBox='0 0 16 16' width={size} {...props}>
